...
export const DocumentTab = ({ user, initialData, apiEndpoint, moduleLabel }: DocumentTabProps) => {
  ...
  return (
    <DebugLabel label={moduleLabel} className="flex flex-col flex-grow border-t border-accent/20 overflow-hidden relative">
